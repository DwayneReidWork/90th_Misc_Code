...
int main()
{
    int8_t integer_8_bits = 
# 16 "blank.c" 3 4
                           (127)
# 16 "blank.c"
                                   ;
    uint8_t uinteger_8_bits = 
# 17 "blank.c" 3 4
                             (255)
# 17 "blank.c"
                                      ;
    int16_t integer_16_bits = 
# 18 "blank.c" 3 4
                             (32767)
# 18 "blank.c"
                                      ;
    uint16_t uinteger_16_bits = 
# 19 "blank.c" 3 4
                               (65535)
# 19 "blank.c"
                                         ;
    int32_t integer_32_bits = 
# 20 "blank.c" 3 4
                             (2147483647)
# 20 "blank.c"
                                      ;
    uint32_t uinteger_32_bits = 
# 21 "blank.c" 3 4
                               (4294967295U)
# 21 "blank.c"
                                         ;
    int64_t integer_64_bits = 
# 22 "blank.c" 3 4
                             (9223372036854775807L)
# 22 "blank.c"
                                      ;
    uint64_t uinteger_64_bits = 
# 23 "blank.c" 3 4
...
# 23 "blank.c"
    ...
    printf("Unsigned 8: %u\n", uinteger_8_bits);
    printf("Signed 16: %d\n", integer_16_bits);
    printf("Unsigned 16: %d\n", uinteger_16_bits);
    printf("Signed 32: %d\n", integer_32_bits);
    printf("Unsigned 32: %u\n", uinteger_32_bits);
    printf("Signed 64: %lld\n",integer_64_bits);
    printf("Unsigned 64: %llu\n",uinteger_64_bits);

    uint_fast32_t sum = 0;
    for (uint_fast8_t i = 0; i < (uint8_t)255; i++)
    {
        sum += i + 1;
    }
    printf("The sum from my for loop is %u\n", sum);
...
# 45 "blank.c"
                     - b)
    {
        printf("Overflow error: cannot add %d and %d.\n", a, b);
    }
    else
    {
        result = a + b;
